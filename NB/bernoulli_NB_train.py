'''
@rana
bernoulli naive bayes training code
'''
...
import features_bool as features
import pickle
import time

start_time = time.time()

feature_file_train = "feature_vec_train_bnb.p"
feature_file_test = "feature_vec_test_bnb.p"
label_file_train = 'label_list_train_bnb.p'
label_file_test = 'label_list_test_bnb.p'
