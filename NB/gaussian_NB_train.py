'''
@rana
gaussian naive bayes training code
'''
...
import features_cont as features
import pickle
import time

start_time = time.time()

feature_file_train = "feature_vec_train_gnb.p"
feature_file_test = "feature_vec_test_gnb.p"
label_file_train = 'label_list_train_gnb.p'
label_file_test = 'label_list_test_gnb.p'
classifier_file = "gnb_classifier.p"
