'''
@rana
naive bayes features - discrete values
'''
...
def get_average_contrast(feat, text):
        ...
        if type(text) is str:
                try:
                        ...
                        score = int(np.abs(polarityDif) * 100)
                        feat['average_contrast'] = score
                except:
                        feat['average_contrast'] = 0
        else:
                feat['average_contrast'] = 0
...
def get_extreme_contrast(feat, text):
        ...
        if type(text) is str:
                try:
                        ...
                        score = int(np.abs(maxPolarity - minPolarity) *100)
                        feat['extreme_contrast'] = score
                except:
                        feat['extreme_contrast'] = 0
        else:
                feat['extreme_contrast'] = 0
        ...
        if type(text) is str:
                ...
                if len(tokens) == 1:
                        ...
                        try:
                                ...
                                second_half_polarity = 0.0
                        score = int(np.abs(first_half_polarity - second_half_polarity) * 100)
                        feat['half_contrast'] = score
        else:
                feat['half_contrast'] = 0
        ...
        if type(text) is str:
                ...
                if len(tokens) < 2:
                        ...
                        try:
                                ...
                                third_half_polarity = 0.0
                        score1 = int(np.abs(first_half_polarity - second_half_polarity) * 100)
                        score2 = int(np.abs(first_half_polarity - third_half_polarity) * 100)
                        score3 = int(np.abs(second_half_polarity - third_half_polarity) * 100)
                        feat['third_contrast_12'] = score1
                        feat['third_contrast_13'] = score2
                        feat['third_contrast_23'] = score3
        else:
                feat['third_contrast_12'] = 0
                feat['third_contrast_13'] = 0
                feat['third_contrast_23'] = 0
